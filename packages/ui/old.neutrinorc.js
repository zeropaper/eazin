...
const useInProd = plugin => (BUILD_TYPE !== 'components')
  ? plugin
  : null;
...
module.exports = {
  options: {
    root: __dirname,
    output: BUILD_TYPE === 'components' ? 'dist' : 'build',
  },
  use: [
    (neutrino) => {
    ...
    BUILD_TYPE !== 'components'
      ...
      BUILD_TYPE !== 'components' && neutrinoAppPlugin({
      // Your source logo
    ...
    BUILD_TYPE !== 'components' && neutrinoGenerateSW({
